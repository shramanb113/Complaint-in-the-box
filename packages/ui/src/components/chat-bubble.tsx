...
export function ChatBubble({ children, time, className }: ChatBubbleProps) {
  return (
    <div className={cn("rounded-2xl border-[2.5px] border-ink bg-chat-bg p-2.5", className)}>
      <div className="whitespace-pre-wrap rounded-xl rounded-br-sm border-2 border-ink bg-chat px-3 py-2.5 font-mono text-[15px] leading-relaxed motion-safe:animate-pop">
        {children}
      </div>
