...
## email_subject
Item(s) missing from order — Order {{orderId}}, resolution requested by {{deadlineFormatted}}

## email_body
Dear {{companyName}} Grievance Team,

I am writing to formally raise a consumer complaint regarding Order {{orderId}} on {{platformName}}, paid ₹{{amountInr}} on {{paidOnFormatted}}.

The order was delivered, but one or more items I paid for were missing: {{whatHappened}}

{{alreadyDidLine}}

Under the Consumer Protection Act, 2019, delivering an incomplete order while charging for the full order is a deficiency in service and an unfair trade practice. I am requesting {{remedyText}} for the missing item(s), and I expect this to be actioned without further delay.
...
I can provide order confirmation and a photo of the items actually received on request, and I am keeping a record of all correspondence on this matter.
