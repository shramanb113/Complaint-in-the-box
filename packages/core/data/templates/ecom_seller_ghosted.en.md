## whatsapp
Order {{orderId}}, {{platformName}}, paid ₹{{amountInr}} on {{paidOnFormatted}}. {{whatHappened}} The seller has stopped responding to my messages.
{{alreadyDidLine}}
...
## email_subject
Seller unresponsive — Order {{orderId}}, resolution requested by {{deadlineFormatted}}
...
The seller for this order has stopped responding to my messages and has not resolved my issue: {{whatHappened}}
...
I can provide order confirmation and a record of my messages to the seller on request, and I am keeping a record of all correspondence on this matter.
